...
public class OddsId extends AbstractObject<OddsId> implements Serializable{
	...
	public OddsId(String matchId, String batch) {
	...
	public boolean equals(Object obj) {
		...
		if(! (obj instanceof OddsId)) return false;
		OddsId id = (OddsId)obj;
